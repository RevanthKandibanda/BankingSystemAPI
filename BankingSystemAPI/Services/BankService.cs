...
namespace BankingSystemAPI.Services
{
    public class BankService : IBankService
    {
        ...
        //                    new Account { AccountId = 2, Balance = 5000 }
        //                }
        //            },
        //            new User
        //            {
        ...
        //                Accounts = new List<Account>
        //                {
        //                    new Account { AccountId = 3, Balance = 3000 }
        //                }
        //            }
        //        };
        //    }
        //    public User CreateUser()
        //    {
        //        var user = new User { UserId = users.Count + 1 };
        //        users.Add(user);
        //        return user;
        //    }
        ...
        //    public Account CreateAccount(User user)
        //    {
        //        var account = new Account { AccountId = accountIdCounter, Balance = 0 };
        //        accountIdCounter++;
        //        user.Accounts.Add(account);
        //        return account;
        //    }
        ...
        //    public bool Withdraw(Account account, decimal amount)
        //    {
        //        if (account.Balance - amount < 100 || amount > account.Balance * 0.9m)
        //            return false;
